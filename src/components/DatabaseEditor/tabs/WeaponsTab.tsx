    ...
    <>
      <div className="db-content">
        <DatabaseListPanel items={db.items as any} selectedId={db.selectedId} onSelect={db.select}
          onAdd={() => db.addNew(DEFAULT)} label="weapons" />
        {w ? (
            ...
            <div className="db-columns">
              <div className="db-column">
                <div className="db-section">
                  ...
                  <div className="db-field"><span className="db-field-label">Icon</span><input type="text" value={w.icon_name} onChange={e => u({ icon_name: e.target.value })} /></div>
                  ...
                  <div className="db-field"><span className="db-field-label">User Anim</span><input type="number" value={w.animation1_id} min={0} onChange={e => u({ animation1_id: +e.target.value })} /></div>
                  <div className="db-field"><span className="db-field-label">Target Anim</span><input type="number" value={w.animation2_id} min={0} onChange={e => u({ animation2_id: +e.target.value })} /></div>
                </div>
              </div>
              <div className="db-column">
                <div className="db-section">
